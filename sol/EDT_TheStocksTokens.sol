...
contract BasicToken is ERC20Basic {
  ...
  */
  function transfer(address _to, uint256 _value) public returns (bool) {
    ...
    holdersWithdrows[_to] += holdersWithdrows[msg.sender].mul(balances[msg.sender]).div(_value);
...
contract A_EDT_TheStocksTokens is Owned, StandardToken {
  ...
  string public constant name = "EDT Stocks Token";
  
  string public constant symbol = "EST";
  
  uint32 public constant decimals = 0;

    uint256 _totalSupply = 1000000000; // stocks
